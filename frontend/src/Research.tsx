            ...
            <div className="form-grid">
              ...
              <label>
                ...
                <select name="strategy" defaultValue="regime_adaptive" onChange={(e) => {
                  ...
                  {Object.entries(strategyNames).filter(([k]) => !["cross_momentum", "channel_trend", "residual_reversal", "minimum_variance", "fixed_ensemble", "adaptive_specialist", "synthetic_regime", "generated_policy", "pattern_policy", "spectral_rules"].includes(k)).map(([k, v]) => (
