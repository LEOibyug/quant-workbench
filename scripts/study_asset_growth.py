"""Standalone asset growth hypothesis; frozen 72-account development diagnostic."""
...
def main():
    ...
    rows = []
    diagnostics = []
    dest = ROOT / "2026-09-22-asset-growth.json"
    ...
    (ROOT / "2026-09-22-asset-growth-coverage.json").write_text(
