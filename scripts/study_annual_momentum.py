"""Frozen long-only close-to-high and 12-minus-1 momentum comparison."""
...
def main():
    ...
    results = []
    output = ROOT / "2026-09-21-annual-momentum.json"
