"""Predeclared MAX lottery preference: 72 shared-capital accounts."""
...
def main():
    ...
    rows = []
    diagnostics = []
    dest = ROOT / "2026-09-22-max-effect.json"
    for pool, path, start, end in windows:
        ...
        for decision in coverage:
            ...
            assert not set(groups["low_max"]) & set(groups["high_max"])
    ...
    (ROOT / "2026-09-22-max-effect-coverage.json").write_text(
