...
CACHE = Path("artifacts/research/liability-transfer-sec")
# Lookup candidates, accepted only after the SEC submission itself matches.
CIKS = dict(DE=315189,HON=773840,RTX=101829,TMO=97745,DHR=313616,AMGN=318154,SBUX=829224,TGT=27419,CSX=277948,FDX=1048911,CMCSA=1166691,COP=1163165)
EXCLUDED = {}
...
def main():
    ...
    with httpx.Client(
        ...
        for symbol, cik in CIKS.items():
            ...
            (ROOT / "2026-09-22-liability-transfer-fundamentals.json").write_text(
                json.dumps(
