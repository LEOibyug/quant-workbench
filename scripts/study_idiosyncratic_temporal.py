...
from study_idiosyncratic_momentum import forecasts

ROOT = Path("docs/research-results")


def main(
    output_name="2026-09-21-idiosyncratic-temporal.json",
    protocol="2026-09-21-idiosyncratic-temporal-protocol.md",
):
    ...
    for start, end in windows:
        ...
        for method, mapping in forecasts(segment).items():
