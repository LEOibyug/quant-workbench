"""Predeclared expert ablation across all three previously evaluated pools."""
...
def main():
    ...
    results = []
    output = ROOT / "2026-09-21-expert-transfer.json"
    for pool, frame in pools.items():
        for method in ("cross_momentum", "channel_trend", "residual_reversal"):
