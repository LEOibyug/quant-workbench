...
from study_pool_trend import forecasts

ROOT = Path("docs/research-results")


def main(
    output_name="2026-09-21-pool-trend-temporal.json",
    protocol="2026-09-21-pool-trend-temporal-protocol.md",
):
    ...
    for start, end in windows:
        ...
        for method, mapping in forecasts(segment)[0].items():
            if method == "breadth":
                continue
