...
def main() -> None:
    ...
    serve = sub.add_parser("serve", help="Start the unified workbench backend and built UI")
    ...
    if args.command == "serve":
        ...
        uvicorn.run("quant_workbench.api:app", host=args.host, port=args.port, workers=1)
        return
